...
public class GoogleXMPPMessageAdapter {
    ...
    public static Message toGoogleMessage(org.apache.nuvem.cloud.xmpp.api.message.Message nuvemMessage) {
    ...
    public static org.apache.nuvem.cloud.xmpp.api.message.Message toNuvemMessage(Message googleMessage) {
        String sender = googleMessage.getFromJid().getId();
        org.apache.nuvem.cloud.xmpp.api.message.Message nuvemMessage =
            new org.apache.nuvem.cloud.xmpp.api.message.MessageBuilder().from(sender).containing(googleMessage.getBody())
                .build();
        return nuvemMessage;
    }
}
